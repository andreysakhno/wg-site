	...
	window.addEventListener("load", function (e) {
		...
		function showMoreActions(e) {
			...
			if (targetType === 'click') {
				...
				const showMoreBlock = document.querySelectorAll("[data-showmore]");
				...
				if (targetEvent.closest(`input[type="checkbox"]`) ) {
					let targetIndex = 0;
					if (targetEvent.closest(`[data-showmore]`)) {
						const showMoreBlock = targetEvent.closest(`[data-showmore]`);
						const showMoreContent = targetEvent.closest(`[data-showmore-content]`);
						const showMoreSpeed = showMoreBlock.dataset.showmoreButton ? showMoreBlock.dataset.showmoreButton : '500';
						const hiddenHeight = getHeight(showMoreBlock, showMoreContent);
						...
						if (!showMoreContent.classList.contains('_slide') && !showMoreBlock.classList.contains('_showmore-active') && showMoreContent.dataset.showmoreContent < targetIndex) {
